          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-surface hover:bg-surface-elevated transition-all duration-200"
                aria-label="Toggle theme"
              >
                {mounted && theme === "dark" ? (
                  <Sun className="w-5 h-5 text-text-secondary" strokeWidth={2} />
                ) : (
                  <Moon className="w-5 h-5 text-text-secondary" strokeWidth={2} />
                )}
              </button>
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 glass-effect rounded-2xl shadow-xl border border-border-subtle py-2 z-50 fade-in">
                      <div className="px-4 py-3 border-b border-border-subtle">
                        <div className="text-sm font-medium text-text-primary">John Doe</div>
                        <div className="text-xs text-text-tertiary">john.doe@lifelink.com</div>
                      </div>
                      
                      <div className="py-2">
                        <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-text-secondary hover:bg-surface hover:text-text-primary transition-colors">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-border-subtle bg-surface/50">
          <div className="text-xs text-text-quaternary text-center">
            © 2026 LifeLink+ • Making a difference
          </div>
        </div>
      </div>
    </>
